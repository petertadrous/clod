...
description: Respond to production incidents with coordinated agent expertise for rapid resolution. Covers immediate response, root cause analysis, fix implementation, stabilization, and post-incident activities including postmortem documentation.
license: MIT
...
metadata:
  ...
  version: "1.0.0"
  domain: commands
  triggers: incident response, production incident, outage, system down, emergency fix, postmortem
  role: expert
  scope: operations
