---
name: sql-pro
description: Optimizes SQL queries, designs schemas, and troubleshoots performance issues. Invoke for window functions, CTEs, indexing strategies, EXPLAIN/ANALYZE, query benchmarking, or migrating between PostgreSQL, MySQL, SQL Server, and Oracle.
---
