---
name: python-pro
description: Python 3.11+ specialist for type-safe, async-first code. Generates type-annotated code, configures mypy strict mode, writes pytest suites, and validates with black/ruff. Invoke for type hints, async/await, dataclasses, and error handling.
---
